...
# ===================== GRID PRINCIPAL (barplot + 5 scatters) ===================== #
...
ggsave(
  filename = file.path(OUT_DIR, paste0("Scatter_degree_Top", TOP_PROP * 100, "pct_by_absDeltaPercentile.pdf")),
  plot = p, width = 16, height = 8
)
ggsave(
  filename = file.path(OUT_DIR, paste0("Scatter_degree_Top", TOP_PROP * 100, "pct_by_absDeltaPercentile.png")),
